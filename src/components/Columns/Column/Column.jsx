...
function Column({
  ...
  const newCardTitle = useSelector((state) => state.tasks.newCardTitles[id], (prevProp, nextProp) => prevProp === nextProp);
  const isListDeleting = useSelector((state) => state.tasks.isDeletingList, (prevProp, nextProp) => prevProp === nextProp);
